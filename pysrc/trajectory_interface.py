...
class OptimizedTrajectoryInterface:
    ...
    def __init__(self, tpr_file: str, xtc_file: str):
        ...
        try:
            ...
            logger.info(f"Initialized trajectory interface: {len(self.universe.atoms)} atoms, "
    ...
    def _build_topology(self) -> None:
        ...
        try:
            ...
            logger.info(f"Topology analysis completed in {elapsed:.2f}s: "
    ...
    def _classify_molecules(self) -> None:
        ...
        selections = {
            ...
            'water': self.universe.select_atoms('resname TIP3 TIP4 SOL WAT OW').residues,
    ...
    def read_frame(self, frame_number: int) -> FrameData:
        ...
        try:
            if frame_number >= len(self.universe.trajectory):
                raise IndexError(f"Frame {frame_number} exceeds trajectory length "
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'atoms_per_molecule': len(self.universe.atoms) / len(self.molecules) if self.molecules else 0,
            'trajectory_size_gb': self.universe.trajectory.totaltime / 1000.0  # Rough estimate
        }
...
class Topology(OptimizedTrajectoryInterface):
    ...
    def __init__(self, tpr_file: str, xtc_file: str):
        ...
        logger.warning("Using legacy Topology interface. Consider migrating to OptimizedTrajectoryInterface.")
...
def create_trajectory_interface(tpr_file: str, xtc_file: str, 
                               legacy_mode: bool = False) -> OptimizedTrajectoryInterface:
    """
